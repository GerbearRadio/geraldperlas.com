...
import backgroundImage from "@assets/background_1750660981029.jpg";
...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-dvd-dark">
      ...
      >
        <div className="absolute inset-0 bg-dvd-dark bg-opacity-40"></div>
