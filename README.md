...
## Behind the Scenes (password gated)
This build includes a **Behind the Scenes** page at:
- `bts.html`

### Turn it on/off + set password
Edit: `data/site-config.json`
...
"bts": {
  ...
  "hint": "Ask me for access."
}
```

### Set your password (quick method)
The site stores **only a hash** (not the plain password).  
Hash formula used is: `sha256( salt + password )`.

If you want, tell me your desired password + salt and I’ll generate the hash for you.

**Note:** This is lightweight gating for a static site (good for “keep casual visitors out”).  
For strong protection, use a host feature like Cloudflare Access or Netlify/Vercel protected routes.
